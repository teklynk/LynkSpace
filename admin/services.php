...
<?php
		...
		if (($_POST['save_main'])) {
			$setupUpdate = "UPDATE setup SET servicesheading='".safeCleanStr($_POST['main_heading'])."', servicescontent='".mysqli_real_escape_string($db_conn, trim($_POST['main_content']))."', datetime='".date("Y-m-d H:i:s")."' WHERE loc_id=".$_GET['loc_id']." ";
