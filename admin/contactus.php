        ...
        <div class="col-lg-8">
            ...
            <form name="contactForm" class="dirtyForm" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <small>&nbsp;&nbsp;<a href="//support.google.com/maps/answer/144361?co=GENIE.Platform%3DDesktop&hl=en" target="_blank">How to embed a Google Map</a>&nbsp;&nbsp;<i class='fa fa-question-circle-o'></i></small>
