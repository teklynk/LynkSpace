        ...
        <div class="col-lg-8">
            ...
            <form name="contactForm" method="post" action="">
                ...
                <div class="form-group">
                    <label>Heading</label>
                    <input class="form-control input-sm count-text" name="contact_heading" maxlength="255"
                           value="<?php echo $rowContact['heading']; ?>" placeholder="Contact Me" required>
                </div>
                <div class="form-group">
                    <label>Intro Text</label>
                    <textarea class="form-control input-sm count-text" name="contact_introtext" rows="3"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control input-sm count-text count-text" name="contact_address" maxlength="255"
                           value="<?php echo $rowContact['address']; ?>" placeholder="123 Fake Street">
                </div>
                <div class="form-group">
                    <label>City</label>
                    <input class="form-control input-sm count-text" name="contact_city" maxlength="100"
                           value="<?php echo $rowContact['city']; ?>" placeholder="Beverly Hills">
                </div>
                <div class="form-group">
                    <label>State</label>
                    <input class="form-control input-sm count-text" name="contact_state" maxlength="100"
                           value="<?php echo $rowContact['state']; ?>" placeholder="CA">
                </div>
                <div class="form-group">
                    <label>Zipcode</label>
                    <input class="form-control input-sm count-text" name="contact_zipcode" maxlength="10"
                           value="<?php echo $rowContact['zipcode']; ?>" placeholder="90210">
                </div>
                <div class="form-group">
                    <label>Phone</label>
                    <input class="form-control input-sm count-text" name="contact_phone" maxlength="100"
                           value="<?php echo $rowContact['phone']; ?>" type="tel" placeholder="555-5555">
                </div>
                <div class="form-group">
                    <label>Hours</label>
                    <textarea class="form-control input-sm count-text" name="contact_hours" rows="3"
                              maxlength="255"><?php echo $rowContact['hours']; ?></textarea>
                </div>
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control input-sm count-text" name="contact_email"
                           pattern="<?php echo $emailValidatePattern ?>" maxlength="100"
                           value="<?php echo $rowContact['email']; ?>" type="email" placeholder="john.doe@email.com">
                </div>
                <div class="form-group">
                    <label>Send To Email</label>
                    <input class="form-control input-sm count-text" name="contact_sendtoemail"
                           pattern="<?php echo $emailValidatePattern ?>" maxlength="100"
