		...
		?>
			<form role="contactForm" method="post" action="">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="contact_mapcode" rows="3" placeholder="Map embed code goes here"><?php echo $row['mapcode']; ?></textarea>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Hours</label>
					<textarea class="form-control" name="contact_hours" rows="3"><?php echo $row['hours']; ?></textarea>
				</div>
				<div class="form-group">
					<label>Email</label>
