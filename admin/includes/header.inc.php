...
<head>
    ...
    <!-- Core CSS Libraries -->
    <link rel="stylesheet" type="text/css" href="/admin/css/admin.min.css">

    <!-- Admin Panel Fonts -->
    <link rel="stylesheet" type="text/css" href="/admin/css/font-awesome.min.css">

    <!-- Admin Panel CSS -->
    <link rel="stylesheet" type="text/css" href="/admin/css/sb-admin.min.css">

    <!-- Custom Fonts from: localfont.com -->
    <link rel="stylesheet" type="text/css" href="/admin/css/fonts.min.css">
    ...
    ?>
    <!-- TinyMCE -->
    <script type="text/javascript" language="javascript" src="/admin/js/tinymce/tinymce.min.js"></script>
    <?php
    }
    ?>
    ...
    ?>
        <!-- CodeMirror -->
        <link rel="stylesheet" type="text/css" href="/admin/css/codemirror/lib/codemirror.min.css">
        <script type="text/javascript" language="javascript" src="/admin/js/codemirror/lib/codemirror.min.js"></script>
        <script type="text/javascript" language="javascript" src="/admin/js/codemirror/mode/css/css.min.js"></script>
    <?php
    }
    ?>

    <!-- Custom Functions -->
    <script type="text/javascript" language="javascript" src="/admin/js/functions.min.js"></script>
