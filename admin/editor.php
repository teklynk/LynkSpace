    ...
    <div class="col-lg-8">
        ...
        <form name="editForm" class="dirtyForm" method="post">
            <div>
                ...
                //Check if dynamic-style.php exists in the themes css folder
                if (file_exists("../themes/".themeOption."/css/dynamic-style.php")){
                    $themeProperties = $_SESSION['themeproperties'];
                    $themeSelectors = $_SESSION['themeselectors'];
                    $themeoptions = $_SESSION['themeoptions'];

                    //Gets the themeproperties session generated from the frontend function getDynamicCss in dynamic-style.php
                    foreach ($themeSelectors as $key => $value) {
                        //echo $value;
                        echo "<div>".$themeSelectors[$key] . ": <input type='color' name='".$themeProperties[$key]."' value='".$themeoptions[$key]."'></div>";
                    }
                }
