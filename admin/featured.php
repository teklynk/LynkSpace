	...
	if (!empty($_POST)) {
		if (!empty($_POST['featured_heading'])) {
			...
			if ($rowFeatured['loc_id'] == $_GET['loc_id']) {
				//Do Update
				$featuredUpdate = "UPDATE featured SET heading='".$_POST['featured_heading']."', introtext='".$_POST['featured_introtext']."', content='".$_POST['featured_content']."', image='".$_POST['featured_image']."', image_align='".$_POST['featured_image_align']."', datetime='".date("Y-m-d H:i:s")."' WHERE loc_id=".$_GET['loc_id']." ";
				mysqli_query($db_conn, $featuredUpdate);
			} else {
				//Do Insert
				$featuredInsert = "INSERT INTO featured (heading, introtext, content, image, image_align, datetime, loc_id) VALUES ('".$_POST['featured_heading']."', '".$_POST['featured_introtext']."', '".$_POST['featured_content']."', '".$_POST['featured_image']."', '".$_POST['featured_image_align']."', '".date("Y-m-d H:i:s")."', ".$_GET['loc_id'].")";
