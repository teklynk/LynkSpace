        ...
        if ($_GET['newcustomer'] || $_GET['editcustomer']) {
            ...
            <form name="customerForm" class="dirtyForm" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control selectpicker show-tick" data-container="body" data-dropup-auto="false" data-size="10" name="customer_icon_select" id="customer_icon_select">
            ...
            if ($_GET['deletecustomer'] && $_GET['deletename'] && $_GET['loc_id'] && !$_GET['confirm']) {
                ...
                $customerDelete = "DELETE FROM customers WHERE id=".$delcustomerId." AND loc_id=" . $_GET['loc_id'] . " ";
