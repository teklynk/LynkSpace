...
if (!empty($_POST)) {
    ...
    if ($userpass == $userpassconfirm) {
        $usersUpdate = "UPDATE users SET username='" . safeCleanStr($username) . "', password=password('" . safeCleanStr($userpass) . "'), email='" . filter_var(trim($useremail), FILTER_VALIDATE_EMAIL) . "', datetime='" . date("Y-m-d H:i:s") . "' WHERE id=" . $userid . " ";
