...
<head>
    ...
    require_once('db/config.php'); //contains DB connection string and global variables
...
<nav class="navbar navbar-static-top" id='top' role="navigation" style="margin-bottom: 0;">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="http://<?php echo $homePageURL; ?>" class="navbar-brand" target="_blank"><img class="pull-left" src="images/cpslogo_v2@2x.png" width="144" alt="" title="" border="0"/></a>
        </div>
