...
$customCss_dir = '../css/cps-style.css'; //physical path to custom css file
$customCss_url = "//".$_SERVER['HTTP_HOST']."/businessCMS/css/cps-style.css"; //web path to custom css file
