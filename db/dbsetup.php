...
$image_url = "//".$_SERVER['HTTP_HOST']."/business/uploads/"; //web path to uploads folder
$image_baseURL = "business/uploads/";
...
$customCss_url = "//".$_SERVER['HTTP_HOST']."/business/css/custom.css"; //web path to custom css file
