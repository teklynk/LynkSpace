...
--
-- Host: localhost
-- Generation Time: Jan 05, 2017 at 11:16 AM
...
INSERT INTO `contactus` (`id`, `heading`, `introtext`, `mapcode`, `email`, `sendtoemail`, `address`, `city`, `state`, `zipcode`, `phone`, `hours`, `datetime`, `author_name`, `loc_id`) VALUES
...
INSERT INTO `featured` (`id`, `heading`, `introtext`, `content`, `image`, `image_align`, `datetime`, `author_name`, `loc_id`) VALUES
(1, 'SOAR - Seeking Online Access to Resources', '', '<p>Welcome to the Chicago Public Schools Integrated Library System...Bringing together print and electronic materials for students and teachers who are Seeking Online Access to Resources. &nbsp; &nbsp; &nbsp;&nbsp;</p>', '', 'right', '2017-01-04 16:20:19', '', 1),
...
INSERT INTO `generalinfo` (`id`, `heading`, `content`, `datetime`, `author_name`, `loc_id`) VALUES
...
(1, 'CPS', '2017-01-05 15:37:39', 'true'),
...
(97, 3, 'Virtual Library High School', 'https://pac.library.cps.edu/?config=11', 0, 'Top', 'true', 10, '2017-01-04 16:27:23', ''),
(98, 2, 'Virtual Library Elementary School', 'https://pac.library.cps.edu/?config=12', 0, 'Top', 'true', 10, '2017-01-04 16:27:23', ''),
(99, 5, 'Contact', 'contact.php?loc_id=10', 0, 'Top', 'false', 10, '2017-01-04 16:27:23', ''),
(100, 4, 'Databases', 'databases.php?loc_id=10', 0, 'Top', 'false', 10, '2017-01-04 16:27:23', ''),
...
(109, 1, 'School Library Home', 'index.php?loc_id=10', 0, 'Top', 'off', 10, '2017-01-04 16:27:23', ''),
...
INSERT INTO `setup` (`id`, `title`, `keywords`, `description`, `headercode`, `config`, `logo`, `ls2pac`, `ls2kids`, `searchdefault`, `author`, `googleanalytics`, `tinymce`, `pageheading`, `servicesheading`, `sliderheading`, `teamheading`, `customersheading`, `servicescontent`, `customerscontent`, `teamcontent`, `disqus`, `datetime`, `author_name`, `loc_id`) VALUES
(1, 'CPS', '', '', '', '1', 'cpslogo@2x.png', 'true', 'true', 1, 'Ryan Jones', '', 1, 'Pages', 'Services', 'Slides ', 'Meet the Librarians', 'Resources', '', 'Download the login information with your CPS login. (en EspaÃ±ol). Charter schools: Contact library@cps.edu for login information.', '', '', '2017-01-05 15:37:39', 'admin', 1),
(2, 'Curie Metro High School', '', 'Marie Sklodowska Curie Metropolitan High School is a public 4â€“year magnet high school located in the Archer Heights neighborhood on the southwest side of Chicago, Illinois, United States. Curie is operated by Chicago Public Schools district.', '', '1820', 'header_logo.png', 'true', 'false', 1, '', '', 1, '', '', '', 'Meet the Librarians', 'Resources', '', '', '', '', '2017-01-04 16:16:00', '', 2),
...
(10, 'Barry Elementary School', '', 'School in Chicago, Illinois Â· Belmont Gardens', '', '2160', '1446552243.png', 'true', 'true', 2, '', '', 1, '', '', 'Slides', 'Meet the Librarians', 'Resources', '', '', 'Great Things are ALWAYS happening at Barry', '', '2017-01-04 16:16:30', '', 10),
...
(1, 'admin', '*7561F5295A1A35CB8E0A7C46921994D383947FA5', 'rjones@tlcdelivers.com', 1, '2017-01-05 15:16:25', '192.168.2.105', 1),
