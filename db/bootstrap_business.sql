...
--
-- Host: localhost
-- Generation Time: Dec 30, 2016 at 08:05 PM
...
(19, 'cpl.png', '', 'CPL', 'http://www.chipublib.org/', 'Provides subscriber access to over 30 databases for children and adults, including JuniorQuest Magazines; ProQuest Newspapers; SIRS Discoverer; Spanish-language databases; and WorldBook.', 'true', 'true', '2016-12-31 00:14:18', 1),
(20, '', 'laptop', 'e CUIP Digital Library', 'http://ecuip.lib.uchicago.edu/', 'Reference and reading materials specially created in support of the CPS curriculum for teachers and students.', 'false', 'true', '2016-12-31 00:13:48', 1),
...
(24, '', 'wpexplorer', 'Explore', 'http://localhost/businessCMS/page.php?loc_id=1', '', 'true', 'true', '2016-12-31 00:27:48', 1),
(25, '', 'database', 'Databases', 'http://localhost/businessCMS/databases.php?loc_id=1', '', 'true', 'true', '2016-12-31 00:27:15', 1),
...
(1, 'CPS', '2016-12-30 21:15:19', 'true'),
...
(54, 2, 'Virtual Library Elementary School', 'https://pac.library.cps.edu/?config=12', 0, 'Top', 'true', 1, '2016-12-31 00:12:51'),
...
(34, 'Positions', '', '<p>Job posting appear here if available.</p>', 'true', 'false', '2016-12-31 00:24:47', 'right', 1),
...
INSERT INTO `setup` (`id`, `title`, `keywords`, `description`, `headercode`, `config`, `logo`, `ls2pac`, `ls2kids`, `searchdefault`, `author`, `googleanalytics`, `tinymce`, `pageheading`, `servicesheading`, `sliderheading`, `teamheading`, `customersheading`, `servicescontent`, `customerscontent`, `teamcontent`, `disqus`, `datetime`, `loc_id`) VALUES
(1, 'CPS', '', '', '', '1', 'cpslogo@2x.png', 'true', 'true', 1, 'Ryan Jones', '', 1, 'Pages', 'Services', 'Slides ', 'Meet the Team', 'Resources', '', 'Download the login information with your CPS login. (en Espa̱ol). Charter schools: Contact library@cps.edu for login information.', '', '', '2016-12-30 21:15:19', 1),
...
(5, 'space-desktop-backgrounds.jpg', 'CTO', 'Mr. Anderson has more than 20 years of experience in information technology strategy, program management, strategic planning and process improvement.', 'Mr. Anderson', 'true', '2016-12-31 00:13:02', 1),
...
(1, 'admin', '*7561F5295A1A35CB8E0A7C46921994D383947FA5', 'rjones@tlcdelivers.com', 1, '2016-12-30 23:42:34', '127.0.0.1', 1),
